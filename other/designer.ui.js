        ...
        $.ajax({
            ...
            success: function(g) {
                ...
                for (var e = 0, c = f.length; e < c; e++) {
                    var d = f[e],
                        h = d._id.$oid;
                    b += '<li vid="' + h + '" def="' + d.definitionId + '"><div class="version_time">' + d.createDate + '<span class="ico dlg_close dock_history_remove"></span></div><div class="version_name">' + d.fullName + '</div><div class="history_remark">' + d.remark + "</div></li>"
                }
                a.html(b);
                Dock.resetVersions();
